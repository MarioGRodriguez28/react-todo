...
const App = () => {
    ...
    return (
        <div className="bg-[url('./assets/images/bg-mobile-light.jpg')] bg-gray-200  dark:bg-gray-900 min-h-screen dark:bg-[url('./assets/images/bg-mobile-dark.jpg')]  bg-contain bg-no-repeat">
            <Header />
